...
public var posts = [
    ...
    //Post(user: billGates, text: "Although we're all relieved to hear the news from @WHO about the end of the Covid pandemic, we must continue to work towards ensuring equitable vaccine distribution.")
]
